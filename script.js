...
function initSimpleMeme() {
    ...
    function updateUrl() {
        ...
        const pngUrl = `${baseUrl}resim.html?${baseParams}`;
...
function initAdvancedMeme() {
    ...
    window.selectMeme = function (memeId) {
        if (!memeId) {
            selectedMeme = null;
            selectedImageUrl = ''; // GitHub resim seçimini temizle
    ...
    window.selectGithubImage = function (imageUrl, imageName) {
        selectedMeme = null;
        selectedImageUrl = imageUrl; // GitHub'dan seçilen resmi kaydet
    ...
    function updateLiveUrls() {
        ...
        if (selectedMeme) {
            ...
            templateParam = `&bg=${encodeURIComponent(selectedImageUrl)}`;
        } else if (customImageUrl.value.trim()) {
            templateParam = `&bg=${encodeURIComponent(customImageUrl.value.trim())}`;
        }

        const pngUrl = `${baseUrl}resim.html?${mainParams}${textParams}${templateParam}`;
    ...
    function setupEventListeners() {
        ...
        customImageUrl.addEventListener('input', () => {
            ...
            if (url) {
                selectedMeme = null; // Template seçimini temizle
                selectedImageUrl = ''; // GitHub resim seçimini temizle
